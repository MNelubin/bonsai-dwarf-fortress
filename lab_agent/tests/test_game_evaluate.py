...
def test_calibration_is_keyed_by_save_and_horizon():
    ...
    assert calibration_for("ourfort16-final", 3600) == {"noop": 0.457143, "ref": 0.617422}
    assert calibration_for("region3-lab", 3600) == {"noop": 0.530528, "ref": 0.611531}
    ...
    # is a fort that starves beside its drink (0.261) and the reference is the butchering
    # chain plus the digging it unlocks (0.701).

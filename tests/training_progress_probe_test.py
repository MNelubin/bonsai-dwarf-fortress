"""Deterministic public test for bridge.training_progress_probe.probe_training_jobs.

This test imports the training progress probe, calls the function with the default timeout,
...
"""
import unittest
from bridge.training_progress_probe import probe_training_jobs


class TrainingProgressProbePublicTest(unittest.TestCase):
    """Basic sanity‑check that the training progress probe returns the expected contract."""

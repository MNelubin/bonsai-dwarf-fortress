"""Deterministic public test for bridge.metal_smelting_progress_probe.probe_smelting_jobs.

This test imports the metal smelting progress probe, calls the function with the default timeout,
...
"""
import unittest
from bridge.metal_smelting_progress_probe import probe_smelting_jobs


class MetalSmeltingProgressProbePublicTest(unittest.TestCase):
    """Basic sanity‑check that the metal smelting progress probe returns the expected contract."""

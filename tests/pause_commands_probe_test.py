"""Deterministic public test for bridge.pause_commands_probe.probe_pause_state.
...
"""
import unittest
from bridge.pause_commands_probe import probe_pause_state


class PauseCommandsProbePublicTest(unittest.TestCase):
    """Basic sanity‑check that the pause state probe returns the expected contract."""

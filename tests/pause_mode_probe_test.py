"""Deterministic public test for bridge.pause_mode_probe.probe_pause_mode.

This test imports the pause mode probe, calls the function with the default timeout,
...
import unittest
from bridge.pause_mode_probe import probe_pause_mode


class PauseModeProbePublicTest(unittest.TestCase):
    """Basic sanity‑check that ``probe_pause_mode`` returns the expected contract schema
